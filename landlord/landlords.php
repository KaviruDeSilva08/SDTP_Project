...
<div class="container">
    ...
    ?>
    <form action="landlordlogin.php" method="post" onsubmit="return validateForm()">
    ...
    <div class="message"> Don't you have an account ? <a href="landlordr.php"><b>Register</b></a></div>
</div>
</body>
</html>
